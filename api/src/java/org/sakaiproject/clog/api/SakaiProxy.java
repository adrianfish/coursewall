...
public interface SakaiProxy {
    ...
    public CoursewallAuthor getAuthor(String memberId);

    public boolean isAutoDDL();

    public List<CoursewallAuthor> getSiteAuthors(String siteId);
    ...
    public String getCoursewallPageId(String siteId);
