...
public class SakaiProxyImpl implements SakaiProxy {
    ...
    public void registerEntityProducer(EntityProducer entityProducer) {
        entityManager.registerEntityProducer(entityProducer, "/coursewall");
    }

    public void registerFunction(String function) {

        List functions = functionManager.getRegisteredFunctions("coursewall.");
    ...
    public Set<String> getSitePermissionsForCurrentUser(String siteId, String embedder) {
        ...
        if (securityService.isSuperUser(userId)) {
            ...
            filteredFunctions.addAll(functionManager.getRegisteredFunctions("coursewall"));
        } else {
            Site site = null;
            ...
            for (String function : functions) {
                if (function.startsWith("coursewall"))
                    filteredFunctions.add(function);
            }

            if (functions.contains("site.upd")) {
                filteredFunctions.add(CoursewallFunctions.COURSEWALL_MODIFY_PERMISSIONS);
            }
        }
